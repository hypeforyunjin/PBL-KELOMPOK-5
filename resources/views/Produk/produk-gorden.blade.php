...
<body class="bg-gray-100 flex ">
    ...
    <div class="flex flex-col flex-1 ml-16 min-h-screen">
        <header class="sticky top-0 bg-white z-40 p-6 flex items-center justify-between shadow-md">
            <form action="{{ route('produk.gorden') }}" method="GET"
                class="flex items-center space-x-4 w-full max-w-4xl mx-auto">
                <div class="relative flex-grow">
                    <input type="text" name="search" placeholder="Cari gorden yang anda inginkan..."
                ...
                <button
                    class="flex items-center space-x-2 px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 shadow-sm">
                    <span class="material-icons text-gray-500">filter_list</span>
                </button>
                <button type="submit"
                    class="flex items-center space-x-2 px-4 py-3 bg-slate-700 text-white rounded-lg hover:bg-slate-800 shadow-sm">
